/**
 * Better Auth table definitions for Convex.
 * Regenerate with: npx auth generate --output convex/schema.ts
 *
 * You can add your own application tables alongside these.
 */
